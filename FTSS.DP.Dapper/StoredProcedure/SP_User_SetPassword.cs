...
{
	public class SP_User_SetPassword : ISP<Models.Database.StoredProcedures.SP_User_SetPassword_Params>
	{
        private readonly ISQLExecuter _ISQLExecuter;
        public SP_User_SetPassword(string cns, ISQLExecuter ISQLExecuter = null)
        {
        ...
        public async Task<DBResult> Call(Models.Database.StoredProcedures.SP_User_SetPassword_Params data)
        {
            if (data == null)
