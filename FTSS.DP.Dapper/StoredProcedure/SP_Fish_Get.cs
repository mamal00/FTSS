...
{
	public class SP_Fish_Get : ISP<Models.Database.BaseIdModel>
	{
        private readonly string _cns;

        public SP_Fish_Get(string cns)
        {
            _cns = cns;
        }
        ...
        public async Task<DBResult> Call(Models.Database.BaseIdModel filterParams)
        {
            ...
            using (var connection = new SqlConnection(_cns))
            {
                ...
                var dbResult = await connection.QueryFirstOrDefaultAsync<Models.Database.StoredProcedures.SP_Fish_GetAll>(
