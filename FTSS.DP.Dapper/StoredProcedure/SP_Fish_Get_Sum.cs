...
{
	public class SP_Fish_Get_Sum : ISP<Models.Database.StoredProcedures.SP_Fish_Get_Sum_Params>
	{
        private readonly string _cns;
        public SP_Fish_Get_Sum(string cns)
        {
            _cns = cns;
        }
        ...
        {
            string sql = "dbo.SP_Fish_Get_Sum";
            DBResult rst = null;
            using (var connection = new SqlConnection(_cns))
            {
                ...
                var dbResult = await connection.QuerySingleOrDefaultAsync<Models.Database.StoredProcedures.SP_Fish_Get_Sum>(
