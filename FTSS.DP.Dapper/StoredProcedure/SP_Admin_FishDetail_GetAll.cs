...
{
	public class SP_Admin_FishDetail_GetAll : ISP<Models.Database.StoredProcedures.SP_FishDetail_GetAll_Params>
	{
        private readonly string _cns;
        public SP_Admin_FishDetail_GetAll(string cns)
        {
            _cns = cns;
        }
        ...
        {
            string sql = "dbo.SP_Admin_FishDetail_GetAll";
            string sqlFishUser = "dbo.SP_Fish_Get";
            DBResult rst = null;
        ...
        public async Task<DBResult> CallReport(Models.Database.StoredProcedures.SP_FishDetail_GetAll_Params filterParams)
        {
            string sql = "dbo.SP_Admin_FishDetail_GetAll";
            DBResult rst = null;
            using (var connection = new SqlConnection(_cns))
